...
/*end*/
    ...
    if(qt602240->pdata->is_tickertab)
	    input_set_abs_params(qt602240->input_dev, ABS_MT_TOUCH_MAJOR, 0, 15, 0, 0);
    else
	...
	input_set_abs_params(qt602240->input_ticker_dev, ABS_MT_PRESSURE, 0, 255, 0, 0);
	input_set_abs_params(qt602240->input_ticker_dev, ABS_MT_TOUCH_MAJOR, 0, 15, 0, 0);
#endif
...
#ifdef QT_FIRMUP_ENABLE
{
    ...
    irq_set_irq_type(qt602240->pdata->irq, IRQ_TYPE_LEVEL_LOW); // IRQ_TYPE_EDGE_FALLING);
